...
public class SystemTestDocWriter extends AbstractSystemTestWriter
  ...
  protected void writeBinding( VarBinding binding)
    ...
    xmlWriter_.writeAttribute(VALUETYPE_ATR, binding.getValueType());
    xmlWriter_.writeAttribute(TESTSTATUS_ATR, binding.getTestStatus());
    xmlWriter_.writeAttribute(TESTIMPORTANCE_ATR, binding.getTestImportance());
    xmlWriter_.writeAttribute( EXPECTEDRESULT_ATR, binding.getExpectedResult());
    xmlWriter_.writeAttribute( VARTYPE_ATR, binding.getVarType());
    xmlWriter_.writeAttribute( VARSIGNIFICANCE_ATR, binding.getVarSignificance());
