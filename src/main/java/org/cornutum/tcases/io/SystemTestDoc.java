...
public final class SystemTestDoc
  ...
  public static final String VARSIGNIFICANCE_ATR     = "varsignificance";
  public static final String VARTYPE_ATR     = "vartype";
    public static final String VALUETYPE_ATR      = "valuetype";
    public static final String TESTSTATUS_ATR      = "teststatus";
    public static final String TESTIMPORTANCE_ATR      = "testimportance";
    public static final String EXPECTEDRESULT_ATR      = "expectedresult";
  }
