...
public class SystemTestDocReader extends DefaultHandler implements ISystemTestSource
  ...
  protected class VarHandler extends AnnotatedHandler
    ...
    public void startElement( String uri, String localName, String qName, Attributes attributes) throws SAXException
      ...
      VarBinding binding =
        ...
        ( requireIdPath( attributes, NAME_ATR),
          parent.getType(), attributes.getValue("vartype"), attributes.getValue("valuetype"), attributes.getValue("teststatus"), attributes.getValue("testimportance"), attributes.getValue("expectedresult"), attributes.getValue("varsignificance"),
    ...
    protected Set<String> addAttributes( Set<String> attributes)
      {
      return addAttributeList( super.addAttributes( attributes), NAME_ATR, VALUE_ATR, FAILURE_ATR, VARSIGNIFICANCE_ATR, VARTYPE_ATR, VALUETYPE_ATR, TESTSTATUS_ATR, TESTIMPORTANCE_ATR, EXPECTEDRESULT_ATR);
      }
