...
public class SystemInputDocReader extends DefaultHandler implements ISystemInputSource
  ...
  protected abstract class VarDefHandler extends ConditionalHandler
    ...
    public void startElement( String uri, String localName, String qName, Attributes attributes) throws SAXException
      {
      setVarDef( createVarDef( requireIdentifier( attributes, NAME_ATR), attributes));
      super.startElement( uri, localName, qName, attributes);
      }
     ...
     */
    public abstract AbstractVarDef createVarDef( String name, Attributes attributes);
    ...
    protected Set<String> addAttributes( Set<String> attributes)
      {
      return addAttributeList( super.addAttributes( attributes), NAME_ATR, VARTYPE_ATR, VARSIGNIFICANCE_ATR);
      }
  ...
  protected class VarHandler extends VarDefHandler
     ...
     * Creates the {@link AbstractVarDef} represented by this element.
     */
    public AbstractVarDef createVarDef( String name, Attributes attributes)
      {
      return new VarDef( name, attributes);
      }
  ...
  protected class VarSetHandler extends VarDefHandler
    ...
    public AbstractVarDef createVarDef( String name, Attributes attributes)
      {
      return new VarSet( name, attributes);
      }
  ...
  protected class ValueHandler extends ConditionalHandler
    ...
    public void startElement( String uri, String localName, String qName, Attributes attributes) throws SAXException
      {
      VarValueDef value = new VarValueDef( requireIdentifier( attributes, NAME_ATR), attributes);
      setValue( value);
    ...
    protected Set<String> addAttributes( Set<String> attributes)
      {
      return addAttributeList( super.addAttributes( attributes), NAME_ATR, FAILURE_ATR, ONCE_ATR, PROPERTY_ATR, VALUETYPE_ATR, TESTSTATUS_ATR, TESTIMPORTANCE_ATR, EXPECTEDRESULT_ATR);
      }
  ...
  private static final String VARTYPE_ATR      = "vartype";
  private static final String VARSIGNIFICANCE_ATR      = "varsignificance";
  ...
  private static final String VALUETYPE_ATR      = "valuetype";
  private static final String TESTSTATUS_ATR      = "teststatus";
  private static final String TESTIMPORTANCE_ATR      = "testimportance";
  private static final String EXPECTEDRESULT_ATR      = "expectedresult";
